    ...
    <Box p={4} textAlign="center" color="gray.200">
      ...
      {analysis && (
        <Box>
          ...
          {analysis.customer_segmentation && analysis.customer_segmentation.fm_table && (
            <Box
              bg="#2c2c2c"
              p={6}
              borderRadius="md"
              ...
              boxShadow="lg"
            >
              <Heading as="h3" size="md" color="teal.200" mb={2}>
                Customer Segmentation
              </Heading>
              <Text fontSize="sm" color="gray.300" mb={4}>
                Top 10 customers by frequency, clustered by Frequency &amp; Monetary
              </Text>
              ...
              {/* Table for top 10 customers */}
              <Text fontSize="md" color="gray.200" my={4}>
                Detailed View of Top Customers
              </Text>
              <Table colorScheme="gray.200" size="sm">
                <Thead>
                  <Tr>
                    <Th>Customer ID</Th>
                    <Th>Frequency</Th>
                ...
                <Tbody>
                  {analysis.customer_segmentation.fm_table.map((row) => (
                    <Tr key={row.CustomerID}>
                      <Td>{row.CustomerID}</Td>
                      <Td>{row.Frequency}</Td>
                      <Td>${row.Monetary.toFixed(2)}</Td>
                      <Td>
                        <ClusterBadge clusterId={row.Cluster} />
                      </Td>
                    </Tr>
                  ))}
                </Tbody>
